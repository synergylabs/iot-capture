...
void loop(){
  ...
  if (CaptureWiFi.driver_connection.available()) {
    ...
    capture_webserver_driver_message_t message = capture_webserver_driver_message_t();
    CaptureWiFi.readFromWebServerDriver(&message);

    switch(message.type) {
      case webserver_driver_msg_type_t::GPIO_26_OFF:
        Serial.println("GPIO 26 off");
        digitalWrite(output26, LOW);
        break;
      case webserver_driver_msg_type_t::GPIO_26_ON:
        Serial.println("GPIO 26 on");
        digitalWrite(output26, HIGH);
        break;
      case webserver_driver_msg_type_t::GPIO_27_OFF:
        Serial.println("GPIO 27 off");
        digitalWrite(output27, LOW);
        break;
      case webserver_driver_msg_type_t::GPIO_27_ON:
