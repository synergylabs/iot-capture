...
CustomCaptureWiFiClass CaptureWiFi(USE_DEFAULT_CAMERA_DRIVER);

const char* ssid = "TEST-DO-NOT-USE-PSK";
const char* password = "WiFiPassword";

void startCameraServer(CustomCaptureWiFiClass captureWiFi);
...
void setup() {
  ...
  startCameraServer(CaptureWiFi);

  Serial.print("Camera Ready! Use 'http://");
  // Serial.print(CaptureWiFi.localIP());
