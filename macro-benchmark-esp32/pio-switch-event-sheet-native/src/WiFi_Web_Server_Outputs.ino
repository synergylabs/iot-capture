...
CaptureWiFiClass CaptureWiFi;

// Replace with your network credentials
const char *ssid = "TEST-DO-NOT-USE-PSK";
const char *password = "WiFiPassword";

// const char* ifttt_trigger = "https://maker.ifttt.com/trigger/append_to_sheet/with/key/cUaZNrS7U0wAsZOzakzVUe";
String ifttt_host = "maker.ifttt.com";
String ifttt_uri = "/trigger/append_to_sheet/with/key/cUaZNrS7U0wAsZOzakzVUe";
const int https_port = 443;

// Set web server port number to 80
CaptureWiFiServer server(80);
...
void postIFTTT(CaptureWiFiClientSecure *client, String gpio_number, String state)
{
  if (state == "off")
  {
    return;
...
void loop()
{
  ...
  CaptureWiFiClient client = server.available(); // Listen for incoming clients
  ...
  {                                // If a new client connects,
    ...
    CaptureWiFiClientSecure ifttt_conn;
    const char *root_ca =
        "-----BEGIN CERTIFICATE-----\n"
